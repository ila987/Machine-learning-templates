...
#calculate mean of the cv as overall accuracy
accuracy = mean(as.numeric(cv))

#apply grid search
#implement the svm kernel using the caret package, to check what the best parameters
library(caret)
